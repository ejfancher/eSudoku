export class LogicCell {
	...
	constructor(value, ord) {
		...
		/* if the 2d board was laid out in a single array row by row top to
		 bottom, a cells ordinal would be that cells index in that array */
		this.ordinal = ord
